...
public:
    TreeNode* buildTree(vector<int>& preorder, vector<int>& inorder) {
        return func1(preorder, 0, preorder.size()-1,
    ...
    TreeNode* func1(vector<int>& preorder, int p_lo, int p_hi,
        ...
        root->left  = func1(preorder, p_lo+1, p_lo+1+left_size-1,
                           inorder, i_lo, i_mid - 1);
        root->right = func1(preorder, p_lo+1+left_size, p_hi,
                           inorder, i_mid + 1, i_hi);
