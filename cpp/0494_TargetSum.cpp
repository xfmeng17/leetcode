...
public:
  ...
  int func1(vector<int> &nums, int S) { return helper1(nums, 0, S, 0); }
  ...
  int func2(vector<int> &nums, int S) {
    ...
    // ** When sum = 0:
    // ** dp[0][0] means we have nothing, and our goal is 0, just can pick
    // noting => 1 choice,
    // ** dp[1][0] means we have { nums[0] }, and our goal is 0, just can noting
    // => 1 choice,
    // ** dp[2][0] means we have { nums[0], nums[1] }, and our goal is 0, just
    // can pick noting => 1 choice,
    // ** and so on...
